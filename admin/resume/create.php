    ...
    <div class="container w-50 py-5">
        ...
        <form action="#" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="category_id" id="category_id" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="client" id="client" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
                <label for="proj_name" class="form-label">proj_name</label>
                <input type="text" class="form-control" name="proj_name" id="proj_name" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
                <label for="proj_url" class="form-label">proj_url</label>
                <input type="text" class="form-control" name="proj_url" id="proj_url" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
